...
- **Versão:** a versão `1.1.0` é declarada em `Config.json` e ecoada no envelope/relatórios; o `CHANGELOG.md` registra a evolução. Nenhum número de versão é duplicado no código.
