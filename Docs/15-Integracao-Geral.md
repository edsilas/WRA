# Windows Resource Auditor v1.1.0 — Integração Geral
...
envelopes e os repassa ao Reporting. Os nomes de campo são idênticos da
produção ao consumo — verificado:

| Campo do envelope | Produzido por `New-WRAResult` | Consumido por Reporting |
|---|---|---|
| `Success`      | sim | sim |
| `Module`       | sim | sim |
| `Operation`    | sim | sim |
