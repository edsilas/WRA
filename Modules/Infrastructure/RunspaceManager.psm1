...
'@
    ...
    try {
        ...
        # scriptblocks (Get-FileHash/Utility, Get-AuthenticodeSignature/Security,
        # Get-Item/Management) estejam disponiveis em cada runspace. Usa a sobrecarga
        # de argumento unico (que NAO exige um PSHost) e define o limite de runspaces
        # por metodo — evitando a dependencia do $Host, historica fonte de falha
        # silenciosa que zerava toda a computacao paralela. Cascata de fallbacks
        # preserva o funcionamento caso alguma etapa nao seja suportada.
        try {
